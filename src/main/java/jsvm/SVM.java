...
public class SVM
{
    ...
    private static ISVMPrint svm_print_stdout = s -> {
        System.out.print(s);
        System.out.flush();
    };

    private static ISVMPrint printFunc = svm_print_stdout;
    ...
    public static void crossValidation(SVMProblem prob, SVMParameter param, int nr_fold, double[] target)
    {
        ...
        if ((param.svmType == C_SVC ||
                param.svmType == NU_SVC) && nr_fold < l) {
            int[] tmp_nr_class = new int[1];
            int[][] tmp_label = new int[1][];
            int[][] tmp_start = new int[1][];
            int[][] tmp_count = new int[1][];
    ...
    public static double predictValues(SVMModel model, SVMNode[] x, double[] dec_values)
    {
        int i;
    ...
    public static double predictProbability(SVMModel model, SVMNode[] x, double[] prob_estimates)
    {
    ...
    public static SVMModel loadModel(String model_file_name) throws IOException
    {
        return loadModel(new BufferedReader(new FileReader(model_file_name)));
    }

    public static SVMModel loadModel(BufferedReader fp) throws IOException
    {
        // read parameters
    ...
    public static String checkParameter(SVMProblem prob, SVMParameter param)
    {
        // svm_type
    ...
    public static int checkProbabilityModel(SVMModel model)
    {
        if (((model.param.svmType == C_SVC || model.param.svmType == NU_SVC) &&
                model.probA != null && model.probB != null) ||
    ...
    public static void setPrintFunc(ISVMPrint print_func)
    {
        if (print_func == null)
            printFunc = svm_print_stdout;
        else
